...
var getItemWithExpiry = (key, defaultValue = null) => {
  ...
  if ((/* @__PURE__ */ new Date()).getTime() > rawExpiry.expiry) {
    removeItem(key);
    return defaultValue;
  }
  ...
  async enable() {
    ...
    if (existedSDK && existedSDK.isBlocto) {
      ...
      return new Promise((resolve2, reject) => (
        ...
        setTimeout(() => existedSDK.enable().then(resolve2).catch(reject), 10)
      ));
    }
...
*/
//# sourceMappingURL=blocto-sdk.module-HPQ4IEMA.js.map
